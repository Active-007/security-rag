...
if __name__ == '__main__':
    ss = StrategySelector()
    # ss.select_strategy('比较安保执勤和武装押运在枪械管理方面的区别')
    # ss.select_strategy('武装押运的基本流程是什么')
    ss.select_strategy('押运途中遇到武装抢劫且通讯中断怎么处理')
    # ss.select_strategy('我有一个100000条数据的文件，可以把它一次性存入mysql数据库吗')
